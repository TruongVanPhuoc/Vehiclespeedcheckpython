#Theo dõi đối tượng và tìm đối tượng di chuyển 
import cv2
import math
import time
import numpy as np
...
file = open("C://Users//GIN PC//Documents//Projectfinal//SpeedRecord.txt","w")
file.write("ID \t SPEED\n------\t-------\n")
file.close()

# theo doi bằng khoảng cách ơ-clid
class EuclideanDistTracker:
    def __init__(self):
        ...
        #self.start = 0
        #self.stop = 0
        #Tạo mảng gồm 0 phần tử  kích thước 1x100
        self.et=0
        ...
        for rect in objects_rect:
            ...
            for id, pt in self.center_points.items():
                ...
                if dist < 70:
                    ...
                    #Vị trí khi xe bắt đầu đi qua vùng quan sát  qua 2 vạch và đếm  
                    #START TIMER
                    if (y >= 410 and y <= 430):
    ...
    def capture(self,img,x,y,h,w,sp,id):
        if(self.capf[id]==0):
            ...
            file = 'C://Users//GIN PC//Documents//Projectfinal//record//' + n + '.jpg'
            cv2.imwrite(file, crop_img)
            self.count += 1
            filet = open("C://Users//GIN PC//Documents//Projectfinal//SpeedRecord.txt", "a")
            if(sp>limit):
                file2 = 'C://Users//GIN PC//Documents//Projectfinal//record//exceeded//' + n + '.jpg'
    ...
    #TEXT FILE SUMMARY
    def end(self):
        file = open("C://Users//GIN PC//Documents//Projectfinal//SpeedRecord.txt", "a")
        file.write("\n-------------\n")
        file.write("-------------\n")
        file.write("SUMMARY\n")
        file.write("-------------\n")
